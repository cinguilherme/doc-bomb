...
return (new CustomEvent(event_name,(function (){var obj27746 = {"detail":data};
return obj27746;
})()));
} else {
...
var args27751 = [];
var len__25923__auto___27757 = arguments.length;
var i__25924__auto___27758 = (0);
while(true){
if((i__25924__auto___27758 < len__25923__auto___27757)){
args27751.push((arguments[i__25924__auto___27758]));

var G__27759 = (i__25924__auto___27758 + (1));
i__25924__auto___27758 = G__27759;
continue;
} else {
}
break;
...
var f = (function (){var pred__27754 = cljs.core._EQ_;
var expr__27755 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27754.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27755))){
return ((function (pred__27754,expr__27755){
return (function (p1__27747_SHARP_){
return console.warn(p1__27747_SHARP_);
});
;})(pred__27754,expr__27755))
} else {
if(cljs.core.truth_(pred__27754.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27755))){
return ((function (pred__27754,expr__27755){
return (function (p1__27748_SHARP_){
return console.debug(p1__27748_SHARP_);
});
;})(pred__27754,expr__27755))
} else {
if(cljs.core.truth_(pred__27754.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27755))){
return ((function (pred__27754,expr__27755){
return (function (p1__27749_SHARP_){
return console.error(p1__27749_SHARP_);
});
;})(pred__27754,expr__27755))
} else {
return ((function (pred__27754,expr__27755){
return (function (p1__27750_SHARP_){
return console.log(p1__27750_SHARP_);
});
;})(pred__27754,expr__27755))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27761){
var map__27764 = p__27761;
...
var eval_fn = cljs.core.get.call(null,map__27764__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27766_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27768,(0),null);
var v = cljs.core.nth.call(null,vec__27768,(1),null);
...
var args27771 = [];
var len__25923__auto___27774 = arguments.length;
var i__25924__auto___27775 = (0);
while(true){
if((i__25924__auto___27775 < len__25923__auto___27774)){
args27771.push((arguments[i__25924__auto___27775]));

var G__27776 = (i__25924__auto___27775 + (1));
i__25924__auto___27775 = G__27776;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1658328680323