...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__31719_SHARP_){
return ((p1__31719_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__31719_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__31721,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__31721;
}
});
...
var len__25923__auto___31724 = arguments.length;
var i__25924__auto___31725 = (0);
while(true){
if((i__25924__auto___31725 < len__25923__auto___31724)){
args__25930__auto__.push((arguments[i__25924__auto___31725]));

var G__31726 = (i__25924__auto___31725 + (1));
i__25924__auto___31725 = G__31726;
continue;
} else {
}
break;
...
var G__31723 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__31723,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__31723;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq31722){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31722));
});
...
var vec__31732 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__31732,(0),null);
var names = cljs.core.nth.call(null,vec__31732,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31732,tag_name,names){
return (function (p1__31727_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__31727_SHARP_));
});})(matches,vec__31732,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31732,tag_name,names){
return (function (p1__31728_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__31728_SHARP_));
});})(matches,vec__31732,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__31735){
var vec__31742 = p__31735;
...
var tag = first__31744;
var content = seq__31743__$1;
...
var vec__31745 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__31745,(0),null);
var id = cljs.core.nth.call(null,vec__31745,(1),null);
var class$ = cljs.core.nth.call(null,vec__31745,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1658325512183