    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src/stories","files":"**/*.stories.js","importPathMatcher":"^\\.[\\\\/](?:src\\/stories(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.js)$"},{"titlePrefix":"","directory":"./out","files":"**/*_story.js","importPathMatcher":"^\\.[\\\\/](?:out(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?_story\\.js)$"}];
