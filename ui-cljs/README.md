...
* [`src/ui_cljs/`](src/ui_cljs/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/ui_cljs/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `ui-cljs` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/ui_cljs/config.cljs) defaults to `true` in
...
```clj
(ns ui-cljs.example
  (:require [ui-cljs.config :as config])
